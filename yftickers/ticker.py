    ...
    def history(
        ...
        if actions:
            ...
            if dividends:
                ...
                valid_mask = pos != -1
                if valid_mask.any():
                    df.iloc[pos[valid_mask], df.columns.get_loc("Dividends")] = np.array(div_amounts)[valid_mask]
            ...
            if splits:
                ...
                valid_mask = pos != -1
                if valid_mask.any():
                    df.iloc[pos[valid_mask], df.columns.get_loc("Stock Splits")] = np.array(split_ratios)[valid_mask]
